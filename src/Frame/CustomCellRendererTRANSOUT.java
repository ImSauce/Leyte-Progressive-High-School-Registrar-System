...
public class CustomCellRendererTRANSOUT extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        for (int col = 0; col < table.getColumnCount(); col++) {
            ...
            if (cellValue != null && (cellValue.toString().equals("Complete") || cellValue.toString().equals("complete"))) {
                cellComponent.setBackground(new Color(255, 186, 86 )); // Set the background color to green
